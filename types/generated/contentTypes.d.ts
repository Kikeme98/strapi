...
export interface ApiInvitationInvitation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ceremonyAddress: Schema.Attribute.String;
    ceremonyTime: Schema.Attribute.String;
    ceremonyVenue: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    receptionAddress: Schema.Attribute.String;
    receptionTime: Schema.Attribute.String;
    receptionVenue: Schema.Attribute.String;
    rsvpContact: Schema.Attribute.String;
    rsvpDeadline: Schema.Attribute.Date;
    ...
    template: Schema.Attribute.Enumeration<
      ['classic', 'modern', 'rustic', 'elegant', 'minimalist']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
